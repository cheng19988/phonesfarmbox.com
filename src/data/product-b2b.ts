...
export const PRODUCT_B2B: Record<string, ProductB2B> = {
  ...
  "remote-control-setup": {
    ...
    deploymentNotes: [
      ...
      "Covers wiring and batch-control verification — not operating buyer accounts, platform manipulation, or marketing outcome guarantees.",
    ...
    faq: [
      ...
      { q: "What is not included?", a: "Operating buyer accounts, traffic guarantees, TikTok or social media performance promises, or running buyer proxies/tools on your behalf." },
