...
function p(
  ...
  return {
    ...
    scenarios: extra?.scenarios || [
      ...
      "App testing, QA automation, and compatibility checks",
      "Digital marketing and ad verification workflows",
      "Scaled mobile task automation on real devices",
    ],
...
export const PRODUCT_SEEDS: ProductSeed[] = [
  p("phone-farm-box", "Phone Farm Box", "Phone Farm Box", "Real smartphones in a unified box — centralized heat dissipation, unified power, and PC batch control for hundreds of device windows.", IMAGES.phoneFarmBox, 728, 18, {
    ...
    features: [
      "Real phone hardware with phone frame — SIM and camera support",
      "Customized ROM: auto-reconnect, factory reset, no authorized PC required",
      "3–8 fan cooling keeps performance stable under 24/7 load",
      "Stackable boxes for modular capacity expansion",
      "Includes USB cables, power cords, and control software",
    ],
    specs: {
      "Node Type": "Real smartphone (screenless, battery removed)",
      "Capacity": "20 phones per box",
      "Cooling": "3–8 active cooling fans",
      "SIM Support": "Yes — model dependent",
      "Camera Support": "Yes",
      "System": "Customized ROM (official ROM available on request)",
      "Control": "PC batch group software",
    },
  }),
